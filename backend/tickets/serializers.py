...
class TicketSerializer(serializers.ModelSerializer):
    ...
    # We will handle category assignment manually in views.py based on name matching logic
    # allowing for complex lookup (Org specific vs Global)
    ...
    class Meta:
        ...
        read_only_fields = ['created_at', 'updated_at', 'created_by', 'organization', 'assigned_to', 'status']
